...
trained_model = "F:\LearningPython\image-classify-server-master\classify_image\inception_model".format(
    base_path=os.path.abspath(os.path.dirname(__file__)))
...
def tf_classify(image_file, k=MAX_K):
    ...
    frozen_graph = "tf_inception/staticfiles/graph.pb"
    label_path = "tf_inception/staticfiles/labels.txt"
    #F:/LearningPython/image-classify-server-master/classify_image/inception_model
